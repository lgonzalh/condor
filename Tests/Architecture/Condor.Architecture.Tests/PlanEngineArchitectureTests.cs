...
public class PlanEngineArchitectureTests
{
    [Theory]
    [InlineData("PlanGenerator.cs")]
    [InlineData("PlanIntent.cs")]
    public void PlanLogica_EsPura_NoRealizaIO(string fileName)
    {
        var path = ArchivoFuente("Src/Condor.Core/Planning", fileName);
