...
public class CycleEngineArchitectureTests
{
    [Theory]
    [InlineData("CycleEngine.cs")]
    public void CycleLogica_EsPura_NoRealizaIO(string fileName)
    {
        var path = ArchivoFuente("Src/Condor.Core/Cycle", fileName);
