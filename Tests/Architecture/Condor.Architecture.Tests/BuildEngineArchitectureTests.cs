...
public class BuildEngineArchitectureTests
{
    [Theory]
    [InlineData("BuildDeriver.cs")]
    public void BuildLogica_EsPura_NoRealizaIO(string fileName)
    {
        var path = ArchivoFuente("Src/Condor.Core/Building", fileName);
