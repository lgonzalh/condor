...
public class VisionEngineArchitectureTests
{
    [Theory]
    [InlineData("VisionGate.cs")]
    public void VisionLogica_EsPura_NoRealizaIO(string fileName)
    {
        var path = ArchivoFuente("Src/Condor.Core/Vision", fileName);
