...
public class ModelSelectionArchitectureTests
{
    [Theory]
    [InlineData("ModelSelector.cs")]
    public void ModelSelectionLogica_EsPura_NoRealizaIO(string fileName)
    {
        var path = ArchivoFuente("Src/Condor.Core/Selection", fileName);
